...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <!--signup-->
      <form id="register_form" action="./update_status_connect.php" method="POST">
      ...
      <div class="form-group">
        <select class="form-control" name="status" id="division">
            <option value="Verified">Verified</option>
            <option value="Ban">Ban</option>
        </select>
        </div>
        <div class="form-group">
          <input type="text" class="form-control" id="exampleInputText" placeholder="Updated By- <?php echo $_SESSION["hname"]?>" disabled>
        </div>
          <div class="form-group">
          <input type="text" class="form-control" id="exampleInputText" placeholder="<?php echo date('d-m-Y h:ia')?>" disabled>

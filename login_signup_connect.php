	...
	else
	{
			...
			exit();
				...
				if($resultcheck > 0)
				{
					...
					('$hname','$email','$pwd','$status','0','$store_ip','$date');";
					mysqli_query($conn,$sql);
					$sql= "INSERT INTO profiledetail (hname,email) VALUES 
					('$hname','$email');";
					mysqli_query($conn,$sql);
					$sql= "INSERT INTO promotion (hname,oldrank,newrank,updatedby,updatedate) VALUES 
					('$hname','N/A','Recruit','ADMIN','$date');";
					mysqli_query($conn,$sql);
					$sql= "INSERT INTO demotion (hname,oldrank,newrank,updatedby,updatedate) VALUES 
					('$hname','N/A','N/A','ADMIN','$date');";
					mysqli_query($conn,$sql);

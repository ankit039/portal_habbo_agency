        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <form class="form-inline">
            <a href="./login_signup"><button class="btn btn-m btn-outline-secondary" type="button">Logout</button></a>
              ...
              <ul class="nav-item">
              <a href="./l_profile?hname=tilhanda"><img src="https://www.habbo.com/habbo-imaging/avatarimage?direction=4&head_direction=2&gesture=sml&size=m&user=tilhanda" class="rounded float-right" alt="tilhanda" height="50px" width="50px" style="border-radius: 50%;"></a>
              </ul>
      </nav>
